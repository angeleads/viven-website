...
export default async function InvestmentSection() {
  const t = await getTranslations("administradorDeFincas.investmentSection");
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-2xl hover:shadow-blue-500/20 transition-all duration-500">
              ...
              <div className="grid gap-6">
                <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-2xl hover:bg-blue-100 transition-colors">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">{t("items.urbanLand.title")}</h4>
                    <p className="text-gray-600">
                      {t("items.urbanLand.description")}
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-red-50 rounded-2xl hover:bg-red-100 transition-colors">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">
                      {t("items.realEstateAssets.title")}
                    </h4>
                    <p className="text-gray-600">
                      {t("items.realEstateAssets.description")}
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-2xl hover:bg-blue-100 transition-colors">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">
                      {t("items.newDevelopments.title")}
                    </h4>
                    <p className="text-gray-600">
                      {t("items.newDevelopments.description")}
                    </p>
                  </div>
                </div>
              </div>
