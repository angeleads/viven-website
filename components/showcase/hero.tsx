    ...
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 py-20 lg:py-28">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div
            className={`${shouldShowFeaturedSection ? "lg:col-span-7" : "lg:col-span-12"} space-y-8 text-left mt-4 md:mt-0`}
          >
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-medium text-sky-300 uppercase tracking-wider">
                        {activeProperty?.operationType ||
                          t("card.defaultOperation")}{" "}
                        · {t("card.referenceShort")}{" "}
              ...
              <div className="hidden sm:flex absolute -top-6 -right-4 bg-slate-900/90 backdrop-blur-xl border border-white/20 rounded-2xl p-3 shadow-xl items-center gap-3 z-30">
                ...
                <div className="text-xs pr-2">
                  <p className="font-bold text-white">
                    {t("floating.safeTitle")}
                  </p>
                  <p className="text-slate-400">{t("floating.safeSubtitle")}</p>
                </div>
              </div>

              <Link href="/empresa/#team-section">
                <div className="hidden sm:flex absolute -bottom-6 -left-6 bg-slate-900/90 backdrop-blur-xl border border-white/20 rounded-2xl p-3 shadow-xl items-center gap-3 z-30 transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-105 hover:bg-slate-900 hover:border-blue-500/50 hover:shadow-blue-500/10 hover:shadow-2xl cursor-pointer group">
                  <div className="p-2 rounded-xl bg-blue-500/20 text-blue-400 transition-transform duration-300 group-hover:scale-110 group-hover:bg-blue-500/30">
                    <PhoneCall className="w-5 h-5 transition-transform duration-300 group-hover:rotate-12" />
                  </div>
                  <div className="text-xs pr-2">
                    <p className="font-bold text-white transition-colors group-hover:text-blue-300">
                      {t("floating.fastTitle")}
                    </p>
                    <p className="text-slate-400">
                      {t("floating.fastSubtitle")}
                    </p>
                  </div>
                </div>
              </Link>
